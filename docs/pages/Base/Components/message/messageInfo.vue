...
<template>
    <div class="card">
        ...
        <div class="body">
            <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In massa ipsum, laoreet quis mollis
                nec, feugiat in dui. Suspendisse et enim pretium, ullamcorper enim laoreet.</p><span class="username">from:
                @Yaya12085</span>
            <div class="footer">
                <div>
