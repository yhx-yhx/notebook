    ...
    !function(e, t) {
      ...
      return function(e) {
        ...
        Object.defineProperty(t, "__esModule", { value: true }), t.createDom = function() {
          var e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "div", t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", n2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i2 = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "", o2 = document.createElement(e2);
          return o2.className = i2, o2.innerHTML = t2, Object.keys(n2).forEach(function(t3) {
            var i3 = t3, r2 = n2[t3];
            "video" === e2 || "audio" === e2 ? r2 && o2.setAttribute(i3, r2) : o2.setAttribute(i3, r2);
          }), o2;
        ...
        }(), r = n(4), a = (i = r) && i.__esModule ? i : { default: i };
        var s = function() {
          function e2() {
            !function(e3, t2) {
              if (!(e3 instanceof t2))
          ...
          return o(e2, [{ key: "setLogger", value: function(e3) {
        ...
        var o = "undefined" != typeof window && window.location.href.indexOf("danmu-debug") > -1, r = function() {
          function e2(t2) {
            !function(e3, t3) {
              if (!(e3 instanceof t3))
                throw new TypeError("Cannot call a class as a function");
        ...
        }(), o = f(n(7)), r = n(26), a = f(n(1)), s = f(n(27)), l = f(n(32)), u = n(33), c = n(0);
        function f(e2) {
        ...
        var d = t.DanmuJs = function(e2) {
          function t2(e3) {
            ...
            n2.setLogger("danmu"), n2.logger && n2.logger.info("danmu.js version: " + r.version);
            ...
            if ((0, c.deepCopy)(i2, e3), (0, o.default)(n2), n2.globalHooks = {}, i2.hooks && n2.hooks(i2.hooks), n2.hideArr = [], n2.recycler = new l.default(), n2.freezeId = null, i2.comments.forEach(function(e4) {
        ...
        "use strict";
        var i, o, r, a, s, l, u, c = n(8), f = n(25), h = Function.prototype.apply, d = Function.prototype.call, p = Object.create, g = Object.defineProperty, v = Object.defineProperties, m = Object.prototype.hasOwnProperty, y = { configurable: true, enumerable: false, writable: true };
        o = function(e2, t2) {
          var n2, o2;
          ...
          if ("object" == typeof (i2 = n2[e2]))
            for (r2 = 0; o2 = i2[r2]; ++r2)
              o2 !== t2 && o2.__eeOnceListener__ !== t2 || (2 === i2.length ? n2[e2] = i2[r2 ? 0 : 1] : i2.splice(r2, 1));
          else
            i2 !== t2 && i2.__eeOnceListener__ !== t2 || delete n2[e2];
          return this;
        }, emit: a = function(e2) {
          var t2, n2, i2, o2, r2;
          if (m.call(this, "__ee__") && (o2 = this.__ee__[e2]))
            if ("object" == typeof o2) {
        ...
        } }, l = { on: c(i), once: c(o), off: c(r), emit: c(a) }, u = v({}, l), e.exports = t = function(e2) {
        ...
        (e.exports = function(e2, t2) {
          var n2, o2, l, u, c;
          return arguments.length < 2 || "string" != typeof e2 ? (u = t2, t2 = e2, e2 = null) : u = arguments[2], i(e2) ? (n2 = s.call(e2, "c"), o2 = s.call(e2, "e"), l = s.call(e2, "w")) : (n2 = l = true, o2 = false), c = { value: t2, configurable: n2, enumerable: o2, writable: l }, u ? r(a(u), c) : c;
        }).gs = function(e2, t2, n2) {
          var l, u, c, f;
          return "string" != typeof e2 ? (c = n2, n2 = t2, t2 = e2, e2 = null) : c = arguments[3], i(t2) ? o(t2) ? i(n2) ? o(n2) || (c = n2, n2 = void 0) : n2 = void 0 : (c = t2, t2 = n2 = void 0) : t2 = void 0, i(e2) ? (l = s.call(e2, "c"), u = s.call(e2, "e")) : (l = true, u = false), f = { get: t2, set: n2, configurable: l, enumerable: u }, c ? r(a(c), f) : f;
        };
      }, function(e, t, n) {
        "use strict";
        ...
        e.exports = JSON.parse('{"version":"1.1.10"}');
      }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: true });
        var i = function() {
        ...
        var u = function(e2) {
          ...
          return function(e3, t3) {
            ...
            for (var e3 in this.logger && this.logger.info("destroy"), this._unbindEvents(), this._cancelDataHandleTimer(), this.channel.destroy(), this.data = [], this)
              delete this[e3];
          } }, { key: "_bindEvents", value: function() {
            var e3 = this, t3 = this.danmu, n2 = this.container;
            this._unbindEvents();
            this._events.push([t3, "bullet_remove", function(t4) {
              var n3 = t4.bullet, i2 = e3.data, o2 = e3.queue;
              o2.some(function(e4, t5) {
                return e4.id === n3.id && (o2.splice(t5, 1), true);
              }), i2.some(function(e4) {
            ...
            var e3 = this;
            e3.retryStatus = "normal", e3.sortData(), function t3() {
              "closed" !== e3._status || "stop" !== e3.retryStatus ? ("playing" === e3._status && (e3.readData(), e3.dataHandle()), "stop" === e3.retryStatus && "paused" !== e3._status || (e3.handleTimer = setTimeout(t3, 250))) : e3._cancelDataHandleTimer();
            }();
          } }, { key: "start", value: function() {
            this.logger && this.logger.info("start");
            "playing" !== this._status && (this._status = "playing", this.queue = [], this.container.innerHTML = "", this.channel.reset(), this.init());
          } }, { key: "stop", value: function() {
            this.logger && this.logger.info("stop");
            "closed" !== this._status && (this._status = "closed", this.retryStatus = "stop", this.queue = [], this.container && (this.container.innerHTML = ""), this.channel && this.channel.reset());
          } }, { key: "clear", value: function() {
            ...
            var e3 = this.danmu, t3 = this.interval, n2 = this.channel, i2 = e3.player, o2 = void 0, a2 = void 0;
              ...
              if (a2.length > 0 && n2.checkAvailableTrack(a2[0].mode)) {
                ...
                e:
                  for (var c, f = 0; f < a2.length; f++)
                    if (c = a2[f], this.forceDuration && this.forceDuration !== c.duration && (c.duration = this.forceDuration), (o2 = new r.default(e3, c)).bulletCreateFail) {
                      if (0 === u2)
                        break e;
                      u2--;
                    } else if (o2.attach(), c.attached_ = true, n2.addBullet(o2).result)
                      this.queue.push(o2), o2.topInit(), u2 = 0;
                    else {
                      for (var h in o2.detach(), o2)
                        s.hasOwnProperty.call(o2, h) && delete o2[h];
                      if (o2 = null, c.attached_ = false, c.noDiscard && (c.prior ? this.data.unshift(c) : this.data.push(c)), 0 === u2)
                        break e;
                      u2--;
                    }
              }
            ...
            var e3 = this.danmu, t3 = e3.config, n2 = e3.player, i2 = this.data, o2 = [], r2 = 0;
            if ("number" == typeof t3.maxCommentsLength && i2.length > t3.maxCommentsLength) {
              r2 = i2.length - t3.maxCommentsLength;
              for (var a2, s2 = 0; s2 < r2; s2++)
                (a2 = i2[s2]).prior && !a2.attached_ && o2.push(i2[s2]);
              ...
              if (l2 > 0) {
                for (var u2, c = 0; c < i2.length; c++)
                  if ((u2 = i2[c]).prior && !u2.attached_ && o2.push(i2[c]), u2.start > l2) {
                    r2 = c;
                    break;
                  }
              }
            }
            r2 > 0 && (i2.splice(0, r2), this.data = o2.concat(i2));
          } }, { key: "_getBulletByEvt", value: function(e3) {
            for (var t3, n2 = e3.target || e3.srcElement, i2 = this.queue, o2 = void 0, r2 = 0; r2 < i2.length; r2++)
              if ((t3 = i2[r2]) && t3.el && (t3.el === n2 || t3.el.contains(n2))) {
                o2 = t3;
                break;
              }
            return o2;
        ...
        var c = new r.default("bullet"), f = t.Bullet = function(e2) {
          function t2(e3) {
            var n2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            l(this, t2);
            var i2 = u(this, (t2.__proto__ || Object.getPrototypeOf(t2)).call(this)), o2 = e3.container, r2 = e3.recycler, a2 = e3.config;
            return i2.setLogger(c), i2.danmu = e3, i2.options = n2, i2.duration = n2.duration, i2.id = n2.id, i2.container = o2, i2.mode = "top" === n2.mode || "bottom" === n2.mode ? n2.mode : "scroll", i2.start = n2.start, i2.prior = n2.prior, i2.realTime = n2.realTime, i2.color = n2.color, i2.bookChannelId = n2.bookChannelId, i2.reuseDOM = true, i2.noCopyEl = !(!a2.disableCopyDOM && !n2.disableCopyDOM), i2.recycler = r2, i2._fullySlideInScreenDuration = void 0, i2._lastMoveTime = void 0, i2.status = "waiting", n2.elLazyInit || (i2.bulletCreateFail = !i2._makeEl()), i2;
          }
          return function(e3, t3) {
            if ("function" != typeof t3 && null !== t3)
              throw new TypeError("Super expression must either be null or a function, not " + typeof t3);
            ...
            var e3 = this.danmu, t3 = this.options, n2 = e3.config, i2 = e3.globalHooks, o2 = void 0, r2 = "", s2 = t3.style || {};
              ...
              if (this.noCopyEl && (this.reuseDOM = false), t3.elLazyInit) {
                if ((0, a.isFunction)(i2.bulletCreateEl))
                  try {
                    ...
                    o2 = l2 instanceof HTMLElement ? l2 : l2.el;
                  } catch (e4) {
                  }
                ...
                if (this.reuseDOM) {
                  ...
                  }), (o2 = this.recycler.use()).childNodes.length > 0 && (o2.innerHTML = ""), o2.textContent && (o2.textContent = ""), o2.appendChild(u2);
                } else
                  o2 = t3.el;
            } else
              "string" == typeof t3.txt && ((o2 = this.recycler.use()).textContent = t3.txt);
            if (!o2 || !e3.main)
              return false;
            var c2 = void 0;
            ...
            return s2.left = d, Object.keys(s2).forEach(function(e4) {
              ...
              r2 += t4 + ":" + s2[e4] + ";";
            }), (0, a.styleCSSText)(o2, r2), this.el = o2, t3.like && t3.like.el && this.setLikeDom(t3.like.el, t3.like.style), true;
            ...
            if ("paused" !== t3.status && ("forcedPause" !== t3.status && (this.status = "paused"), t3._moveV = void 0, this.el))
              if ("scroll" === this.mode) {
                ...
                if (e3) {
                  var i2 = ((/* @__PURE__ */ new Date()).getTime() - t3._lastMoveTime) / 1e3, o2 = i2 * this.moveV, r2 = 0;
                  r2 = t3.moveMoreS - o2 >= 0 ? "b2t" === this.direction ? (t3.moveMoreS - o2) / t3.moveContainerHeight * n2.height : (t3.moveMoreS - o2) / t3.moveContainerWidth * n2.width : t3.moveMoreS - o2, "b2t" === this.direction ? (0, a.styleUtil)(this.el, "transform", "translateX(-" + this.top + "px) translateY(" + r2 + "px) translateZ(0px) rotate(90deg)") : (0, a.styleUtil)(this.el, "left", r2 + "px");
                } else
            ...
            if (this.hasMove || (this.danmu.emit("bullet_start", this), this.hasMove = true), ("forcedPause" !== this.status || e3) && this.el && "start" !== this.status)
              if (this.status = "start", "scroll" === this.mode) {
                ...
                if ("b2t" === this.direction) {
                  ...
                  var o2 = (n2.bottom - t3.top) / this.moveV;
                  (0, a.styleUtil)(this.el, "transition", "transform " + o2 + "s linear 0s"), (0, a.styleUtil)(this.el, "transform", "translateX(-" + this.top + "px) translateY(-" + this.height + "px) translateZ(0px) rotate(90deg)"), this._lastMoveTime = (/* @__PURE__ */ new Date()).getTime(), this.moveMoreS = n2.top - t3.top, this.moveContainerHeight = t3.height;
                } else {
                  i2 = n2.right - t3.right;
                  var r2 = n2.right - t3.left, s2 = r2 / this.moveV;
                  n2.right > t3.left ? ((0, a.styleUtil)(this.el, "transition", "transform " + s2 + "s linear 0s"), (0, a.styleUtil)(this.el, "transform", "translateX(-" + r2 + "px) translateY(0px) translateZ(0px)"), this._lastMoveTime = (/* @__PURE__ */ new Date()).getTime(), this.moveMoreS = n2.left - t3.left, this.moveContainerWidth = t3.width) : (this.status = "end", this.remove());
                }
        ...
        var u = function(e2) {
          ...
          return function(e3, t3) {
            if ("function" != typeof t3 && null !== t3)
              throw new TypeError("Super expression must either be null or a function, not " + typeof t3);
            e3.prototype = Object.create(t3 && t3.prototype, { constructor: { value: e3, enumerable: false, writable: true, configurable: true } }), t3 && (Object.setPrototypeOf ? Object.setPrototypeOf(e3, t3) : e3.__proto__ = t3);
          }(t2, e2), o(t2, [{ key: "checkAvailableTrack", value: function() {
            var e3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "scroll", t3 = this.channels, n2 = false;
            if ("scroll" === e3)
              for (var i2, o2 = 0; o2 < t3.length; o2++)
                if (n2 = true, (i2 = t3[o2]).operating[e3])
                  n2 = false;
                else {
                  var r2 = i2.queue[e3][0];
                  if (!r2 || r2.fullySlideIntoScreen) {
                    if (n2)
                      break;
                  } else
                    n2 = false;
            ...
            var t3 = this, n2 = t3.danmu, i2 = n2.container, o2 = n2.bulletBtn;
            function r2() {
              if (t3.danmu && t3.danmu.container) {
                ...
                var n3 = t3._initChannels(), i3 = n3.channelSize, o3 = n3.channelCount, r3 = n3.channels;
                t3.channelCount = o3, t3.channels = r3, "b2t" === t3.direction ? t3.channelWidth = i3 : t3.channelHeight = i3;
              }
            }
            t3.container = i2, o2 && o2.main && o2.main.queue.forEach(function(e4) {
              ...
              e4.attached_ = false;
            }), e3 ? this.resetId = requestAnimationFrame(r2) : r2();
            ...
            if ("b2t" === t3.direction ? (r2 = this.channelWidth, a2 = Math.ceil(e3.width / r2)) : (o2 = this.channelHeight, a2 = Math.ceil(e3.height / o2)), a2 > i2.length)
            ...
            if (-1 !== u2) {
              for (var S = u2, T = u2 + a2; S < T; S++)
                (l2 = i2[S]).operating[e3.mode] = true, l2.queue[e3.mode].unshift(e3), e3.prior && (delete l2.bookId[e3.mode], t3.logger && t3.logger.info(S + "号轨道恢复正常使用")), l2.operating[e3.mode] = false;
              if (e3.prior) {
              ...
              return e3.channel_id = [u2, a2], e3.el.setAttribute("data-line-index", u2 + 1), "b2t" === t3.direction ? (e3.top = u2 * r2, t3.danmu.config.area && t3.danmu.config.area.start && (e3.top += t3.containerWidth * t3.danmu.config.area.start)) : (e3.top = u2 * o2, t3.danmu.config.area && t3.danmu.config.area.start && (e3.top += t3.containerHeight * t3.danmu.config.area.start)), { result: e3, message: "success" };
            }
            ...
            if (this.danmu && this.danmu.config) {
              ...
              if (e3.area) {
                var i2 = e3.area, o2 = i2.lines, r2 = i2.start, a2 = i2.end;
                if ((0, l.validAreaLineRule)(o2))
                  n2 = o2, "b2t" === this.direction ? this.width = n2 * t3 : this.height = n2 * t3;
                else if (r2 >= 0 && a2 >= r2) {
                  var u2 = a2 - r2;
            ...
            function i2(e4, i3) {
              ...
              function r3(n3) {
                t3.channels[n3].queue.bottom.forEach(function(o4) {
                  if (o4.el && (e4[n3 + e4.length - t3.channels.length].queue.bottom.push(o4), o4.channel_id[0] + o4.channel_id[1] - 1 === n3)) {
                    var r4 = [].concat(o4.channel_id);
                    o4.channel_id = [r4[0] - t3.channels.length + e4.length, r4[1]], o4.top = o4.channel_id[0] * i3, t3.danmu.config.area && t3.danmu.config.area.start && (o4.top += t3.containerHeight * t3.danmu.config.area.start), o4.topInit();
                  }
                });
              }
              for (var a2 = 0; a2 < t3.channels.length; a2++)
                n2(e4, a2), o3(a2), r3(a2);
            ...
            function o2(e4, i3) {
              for (var o3 = ["scroll", "top", "bottom"], r3 = function(r4) {
                n2(e4, r4), o3.forEach(function(n3) {
                  if ("top" === n3 && r4 > Math.floor(e4.length / 2))
                    ;
                  else if ("bottom" === n3 && r4 <= Math.floor(e4.length / 2))
                    ;
                  else {
                    var o4 = "bottom" === n3 ? r4 - e4.length + t3.channels.length : r4;
                    t3.channels[o4].queue[n3].forEach(function(a3, s3) {
                      if (a3.el) {
                        if (e4[r4].queue[n3].push(a3), "bottom" === n3 && a3.channel_id[0] + a3.channel_id[1] - 1 === o4) {
                        ...
                        t3.channels[o4].queue[n3].splice(s3, 1);
                      }
                    });
                  }
                });
            ...
            function r2() {
              var e4 = t3.danmu, n3 = e4.container, r3 = e4.bulletBtn;
              t3.container = n3, t3.updatePos(), t3._cancelResizeTimer(), r3.main.data && r3.main.data.forEach(function(e5) {
              ...
              t3.channels && (t3.channels.length <= l2.length ? i2(l2, s2) : o2(l2, s2)), t3.resizing = false;
            }
            t3.resizing || (t3.resizing = true, e3 ? r2() : (this._cancelResizeTimer(), this.resizeId = requestAnimationFrame(r2)));
        ...
        function b(e2, t2) {
          ...
          if (t2.singleton) {
            var a2 = c++;
            n2 = u || (u = m(t2)), i2 = w.bind(null, n2, a2, false), o2 = w.bind(null, n2, a2, true);
          } else
            ...
            }) : (n2 = m(t2), i2 = O.bind(null, n2), o2 = function() {
              v(n2);
            });
        ...
        function x(e2, t2, n2) {
          var i2 = n2.css, o2 = n2.sourceMap, r2 = void 0 === t2.convertToAbsoluteUrls && o2;
        ...
        e.exports = function(e2) {
          ...
          return e2.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(e3, t3) {
            ...
            return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(r) ? e3 : (o = 0 === r.indexOf("//") ? r : 0 === r.indexOf("/") ? n + r : i + r.replace(/^\.\//, ""), "url(" + JSON.stringify(o) + ")");
          });
        };
      }]);
    });
...
var Player = function(_MediaProxy) {
  ...
  _createClass(Player2, [{
    ...
    value: function resetState() {
      var _this16 = this;
      var NOT_ALLOW_AUTOPLAY = STATE_CLASS.NOT_ALLOW_AUTOPLAY, PLAYING2 = STATE_CLASS.PLAYING, NO_START = STATE_CLASS.NO_START, PAUSED = STATE_CLASS.PAUSED, REPLAY2 = STATE_CLASS.REPLAY, ENTER = STATE_CLASS.ENTER, ENDED2 = STATE_CLASS.ENDED, ERROR22 = STATE_CLASS.ERROR, LOADING = STATE_CLASS.LOADING;
      var clsList = [NOT_ALLOW_AUTOPLAY, PLAYING2, NO_START, PAUSED, REPLAY2, ENTER, ENDED2, ERROR22, LOADING];
      this.hasStart = false;
      this.isError = false;
    ...
    value: function onPlaying() {
      var _this23 = this;
      this.isError = false;
      var NO_START = STATE_CLASS.NO_START, PAUSED = STATE_CLASS.PAUSED, ENDED2 = STATE_CLASS.ENDED, ERROR22 = STATE_CLASS.ERROR, REPLAY2 = STATE_CLASS.REPLAY, LOADING = STATE_CLASS.LOADING;
      var clsList = [NO_START, PAUSED, ENDED2, ERROR22, REPLAY2, LOADING];
      clsList.forEach(function(cls) {
    ...
    value: function resizePosition() {
      ...
      var formStyle = util.getTransformStyle(_pos);
...
var Touche = function() {
  ...
  _createClass(Touche2, [{
    ...
    value: function onTouchStart(e) {
      ...
      this.trigger(EVENTS2.TOUCH_START, e);
    }
  }, {
    key: "onTouchCancel",
    value: function onTouchCancel(e) {
    ...
    value: function onTouchEnd(e) {
      ...
      e.press = _pos.press;
      _pos.press && this.trigger(EVENTS2.PRESS_END, e);
      this.trigger(EVENTS2.TOUCH_END, e);
    ...
    value: function onTouchMove(e) {
      ...
      _pos.press = false;
      _pos.moving = true;
      this.trigger(EVENTS2.TOUCH_MOVE, e);
    }
  }, {
    key: "destroy",
    value: function destroy2() {
...
var Download = function(_IconPlugin) {
  ...
  function Download2(args) {
    ...
    _defineProperty(_assertThisInitialized(_this), "download", function(e) {
      ...
      (0, import_downloadjs.default)(url);
      _this.isLock = true;
...
var Subtitle = function(_EventEmitter) {
  ...
  function Subtitle2(options) {
    ...
    _defineProperty2(_assertThisInitialized2(_this), "getItemsByIndex", void 0);
...
danmu.js/dist/index.js:
  (*! Built @Mon, 24 Jul 2023 09:40:27 GMT *)
*/
//# sourceMappingURL=chunk-5Y5CA5XL.js.map
