import{_ as s,j as n,k as a,V as l}from"./chunks/framework.5dd7d4b8.js";const d=JSON.parse('{"title":"scss","description":"","frontmatter":{},"headers":[],"relativePath":"pages/Base/Css/Scss/index.md","filePath":"pages/Base/Css/Scss/index.md","lastUpdated":1706854256000}'),e={name:"pages/Base/Css/Scss/index.md"},p=l(`<h1 id="scss" tabindex="-1">scss <a class="header-anchor" href="#scss" aria-label="Permalink to &quot;scss&quot;">​</a></h1><h2 id="变量" tabindex="-1">变量 <a class="header-anchor" href="#变量" aria-label="Permalink to &quot;变量&quot;">​</a></h2><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">$color:blue;</span></span>
